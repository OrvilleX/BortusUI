...
export default class extends mixins<
  initData<IJobQueryData, IJobData, IJobSearch>,
  initDict
>(initData, initDict) {
  delLoading = false;
  enabledTypeOptions = [
  ...
  private edit(data: IJobData) {
    this.isAdd = false;
    const jobForm = this.$refs.form as eForm;
    jobForm.form = {
      id: data.id,
      name: data.name,
      jobSort: data.jobSort,
